...
const descriptions: Record<TripCostApprovalType, string> = {
  internal: 'Chi phí chuyến sẽ được ghi nhận vào phần kế toán xe nội bộ.',
  vendor: 'Chi phí chuyến sẽ được ghi nhận vào công nợ phải trả cho nhà cung cấp.',
};
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-white p-5 shadow-2xl" onClick={event => event.stopPropagation()}>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[13px] leading-5 text-muted-foreground">{descriptions[approvalType]}</p>
          </div>
        </div>
