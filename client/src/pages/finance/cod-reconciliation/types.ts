...
export interface ListResponse<T> { data?: T[]; items?: T[]; results?: T[]; total?: number; meta?: { total?: number; page?: number; limit?: number; total_pages?: number; totalPages?: number } }
