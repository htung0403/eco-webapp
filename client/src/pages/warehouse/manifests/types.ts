...
export interface ManifestWaybill { id: string | number; waybill_code?: string | null; created_at?: string | null; sender_info?: string | null; receiver_info?: string | null; weight?: number | string | null; length?: number | string | null; width?: number | string | null; height?: number | string | null; volumetric_weight?: number | string | null; payment_type?: string | null; current_state?: string | null; status?: string | null; cost_amount?: number | string | null; origin_hub_id?: string | number | null; dest_hub_id?: string | number | null; dest_hub?: HubSummary | null; package_count?: number | string | null; noi_den?: string | null; receiver_address?: string | null; the_tich_m3?: number | string | null; loading_position?: number | string | null; dispatch_fields?: ManifestDispatchFields | null; }
