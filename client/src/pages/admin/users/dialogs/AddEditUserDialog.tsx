...
import type { UserFieldErrors, UserFormState } from '../types';
import { ROLE_BITS } from '../types';
import { SearchableSelect } from '../../../../components/ui/SearchableSelect';

type Props = { open: boolean; isEdit: boolean; form: UserFormState; errors: UserFieldErrors; submitting: boolean; canSetDirector: boolean; setField: <K extends keyof UserFormState>(key: K, value: UserFormState[K]) => void; onClose: () => void; onSubmit: () => void };

export default function AddEditUserDialog({ open, isEdit, form, errors, submitting, canSetDirector, setField, onClose, onSubmit }: Props) {
  if (!open) return null;
